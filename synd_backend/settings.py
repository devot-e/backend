"""
Django settings for synd_backend project.
...
SECRET_KEY = 'django-insecure-4#+f2to-1)j2)1)wvz()&o5t=mesthp*!1=^86(swg!kjp79^l'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['13.235.78.168', 'localhost', '127.0.0.1']
...
ROOT_URLCONF = 'synd_backend.urls'
...
WSGI_APPLICATION = 'synd_backend.wsgi.application'
